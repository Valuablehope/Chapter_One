...
export const ProductRow = memo<ProductRowProps>(({ product, index, onEdit, onDelete, formatCurrency, visibleColumns }) => {
  return (
    <TableRow index={index} hoverClassName="hover:bg-secondary-50/50">
      ...
      {visibleColumns.includes('actions') && (
        <td className="px-3 py-2 whitespace-nowrap overflow-hidden text-ellipsis text-right min-w-[120px]">
