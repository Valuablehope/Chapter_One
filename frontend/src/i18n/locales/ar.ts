export const ar = {
  ...
  restaurant_pos: {
    ...
    load_failed: "فشل تحميل إعدادات المتجر",
    menu_load_failed: "فشل تحميل القوائم من لوحة المسؤول. حاول مرة أخرى.",
    no_menus: "لا توجد قوائم مُعدّة. اذهب إلى المسؤول ← القوائم لإضافة قوائم.",
    available: "متاحة",
    occupied: "مشغولة",
    bill_requested_short: "طلب فاتورة",
    bill_requested: "طُلبت الفاتورة",
    bill_out: "الفاتورة صادرة",
    table: "طاولة",
    tables: "الطاولات",
    guest_v: "ضيف",
    guests_v: "ضيوف",
    ...
    menu: "القائمة",
    order: "الطلب",
    search_placeholder: "ابحث عن الأصناف في كل القوائم…",
    search_results: "{{count}} نتيجة لـ \"{{query}}\"",
    items_in_category: "{{count}} أصناف",
    no_search_results: "لا توجد أصناف لـ \"{{query}}\"",
    try_different: "جرّب كلمة بحث مختلفة",
    no_items_in_category: "لا توجد أصناف في هذه الفئة",
    order_empty: "الطلب فارغ",
    tap_to_add: "اضغط على الأصناف من القائمة لإضافتها",
    service_fee: "رسوم الخدمة",
    service_fee_on_subtotal: "+{{rate}}٪ على المجموع الفرعي",
    order_notes: "ملاحظات الطلب",
    order_notes_placeholder: "أضف ملاحظة لهذا الطلب (حساسية، طلبات خاصة…)",
    subtotal: "المجموع الفرعي",
    tax_with_rate: "الضريبة ({{rate}}٪)",
    total: "المجموع",
    print_bill: "طباعة الفاتورة",
    reprint_bill: "إعادة طباعة الفاتورة",
    checkout: "الدفع",
    cancel_order: "إلغاء الطلب",
    cancel_order_title: "إلغاء الطلب — {{label}}",
    cancel_order_message: "سيؤدي هذا إلى مسح جميع الأصناف وإغلاق الطلب دون أي رسوم. لا يمكن التراجع عن ذلك.",
    keep_order: "إبقاء الطلب",
    seat_guests_title: "إجلاس الضيوف — طاولة {{table}}",
    edit_guests_title: "تعديل الضيوف — طاولة {{table}}",
    how_many_guests: "كم عدد الضيوف؟",
    seat_guests_cta: "إجلاس {{count}} ضيف",
    update_guests_cta: "تحديث عدد الضيوف",
    checkout_title: "الدفع — {{label}}",
    payment_method: "طريقة الدفع",
    cash: "نقداً",
    card: "بطاقة",
    other: "أخرى",
    ...
    walk_in: "سفري",
    delivery: "توصيل",
    takeaway_delivery: "سفري وتوصيل",
    new_walkin: "سفري جديد",
    new_delivery: "توصيل جديد",
    new_walkin_title: "طلب سفري جديد",
    ...
    delivery_details_required: "الرجاء إدخال اسم الزبون وعنوان التوصيل.",
    no_active_orders: "لا توجد طلبات سفري أو توصيل حالياً"
  },
  dashboard: {
    errors: {
