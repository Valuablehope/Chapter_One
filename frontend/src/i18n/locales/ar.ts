export const ar = {
  ...
  restaurant_pos: {
    ...
    order_notes_placeholder: "أضف ملاحظة (حساسية، طلبات)…",
    subtotal: "المجموع الفرعي",
    ...
    use_exact_amount: "المبلغ الكامل",
  ...
  products: {
    ...
    form: {
      ...
      list_price: "سعر القائمة ($)",
      lbp_list_price: "سعر القائمة (ل.ل)",
      lbp_list_price_helper: "أدخل السعر بالليرة اللبنانية — سيتم احتساب سعر القائمة والهامش تلقائياً",
      margin: "الهامش (%)",
      margin_helper: "هامش الربح",
      sale_price: "سعر البيع ($)",
      lbp_price: "سعر البيع (ل.ل)",
      lbp_price_helper: "أدخل السعر بالليرة اللبنانية — سيتم احتساب سعر البيع والهامش تلقائياً",
      lbp_price_no_rate: "حدد سعر صرف الليرة اللبنانية في الإدارة > الإعدادات الإقليمية لتفعيل هذا الحقل",
