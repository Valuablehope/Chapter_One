export const ar = {
  ...
  restaurant_pos: {
    ...
    cancel_order_title: "إلغاء الطلب — طاولة {{table}}",
    cancel_order_message: "سيؤدي هذا إلى مسح جميع الأصناف وإخلاء الطاولة دون أي رسوم. لا يمكن التراجع عن ذلك.",
    ...
    checkout_title: "الدفع — طاولة {{table}}",
    payment_method: "طريقة الدفع",
    cash: "نقداً",
    card: "بطاقة",
    other: "أخرى",
