export const en = {
  ...
  restaurant_pos: {
    ...
    cancel_order_title: "Cancel Order — Table {{table}}",
    cancel_order_message: "This clears all items and frees the table without charging anything. This cannot be undone.",
    ...
    checkout_title: "Checkout — Table {{table}}",
    payment_method: "Payment Method",
    cash: "Cash",
    card: "Card",
    other: "Other",
