export const en = {
  ...
  restaurant_pos: {
    ...
    order_notes_placeholder: "Add a note (allergies, etc.)…",
    subtotal: "Subtotal",
  ...
  products: {
    ...
    form: {
      ...
      list_price: "List Price ($)",
      lbp_list_price: "List Price (LBP)",
      lbp_list_price_helper: "Enter the LBP price — List Price & Margin are calculated for you",
      margin: "Margin (%)",
      margin_helper: "Profit margin",
      sale_price: "Sale Price ($)",
      lbp_price: "Sale Price (LBP)",
      lbp_price_helper: "Enter the LBP price — Sale Price & Margin are calculated for you",
      lbp_price_no_rate: "Set an LBP exchange rate in Admin > Regional to enable this field",
      tax_rate: "Tax Rate (%)",
