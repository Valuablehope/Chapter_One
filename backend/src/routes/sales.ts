...
router.post(
  ...
  [
    ...
    body('restaurant_context.order_type').optional().isIn(['dine_in', 'takeaway', 'delivery']),
    ...
    body('restaurant_context.customer_name').optional().isString().isLength({ max: 255 }),
    body('restaurant_context.customer_phone').optional().isString().isLength({ max: 50 }),
    body('restaurant_context.delivery_address').optional().isString().isLength({ max: 1000 }),
